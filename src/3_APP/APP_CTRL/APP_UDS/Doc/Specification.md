...
- Communiquer en UART / CAN avec l'ECU pour 
    - Connaitre avec un taux de rafraichissement de 100 ms les valeurs de Sensors/ Actuators
...
Une fois que la communication est établie, suivant ce que veut faire le user, l'application enverra une requête à l'ECU. 

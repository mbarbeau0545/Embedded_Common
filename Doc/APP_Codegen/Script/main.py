...
from AppSns_CodeGen import AppSns_CodeGen as APPSNS
from AppAct_CodeGen import AppAct_CodeGen as APPACT
from AppSdm_CodeGen import AppSdm_CodeGen as APPSDM
from AppSpm_CodeGen import AppSpm_CodeGen as APPSPM
from AppLgc_CodeGen import AppLgc_CodeGen as APPLGC
#------------------------------------------------------------------------------
#                                       CONSTANT
#------------------------------------------------------------------------------
...
def main()-> None:
    ...
    software_cfg_path = str(sys.argv[1])

    if not (os.path.isfile(software_cfg_path)):
        FileNotFoundError("Expected one argument, software Configuration.")
    ...
    soft_udscfg_path = f"Doc\\UdsCfg\\UdsInfo_{soft_version}.json"
